...
const FollowingPostList = () => {
    ...
    let clickDeletePost = async (postId) => {
        const { data } = await axios.delete(
            `https://developerroombackend.onrender.com/api/posts/${postId}`,
            {
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("devroom")}`,
    ...
    let clickLikePost = async (postId) => {
        await axios.put(
            `https://developerroombackend.onrender.com/api/posts/like/${postId}`,
            {},
            {
                headers: {
                    "Content-Type": "application/json",
    ...
    function Nodata() {
        Swal.fire("Nothing is posted by Following users");
    }
