...
let DeveloperDetails = () => {
  ...
  const fetchDeveloper = async () => {
    const { data } = await axios.get(`https://developerroombackend.onrender.com/api/profiles/${developerId}`, {
      headers: {
                  ...
                  <div className="row">
                    <div className="col">
                      ...
                      <div className="container">
                        <div className="row">
                          <div className="col">
                          Following: {selectedProfile.follower.length}
                      
                          </div>
                          <div className="col">
                          Follower: {selectedProfile.following}
                          </div>
                        </div>
                      </div>
