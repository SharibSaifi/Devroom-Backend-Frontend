...
function DeveloperList2() {
  ...
  const fetchProfiles = async () => {
    const { data } = await axios.get(
      "https://developerroombackend.onrender.com/api/profiles/all/me",
      {
        headers: {
  ...
  const fetchFollowList = async() =>{
    let {data,status}  = await axios.get("https://developerroombackend.onrender.com/api/profiles/me", {
         headers: {
           "Content-Type": "application/json",
           Authorization: `Bearer ${localStorage.getItem("devroom")}`,
         },
  ...
  let Unfollow = async(key1) =>{
    await axios.put("https://developerroombackend.onrender.com/api/profiles/unfollow",{unfollowed_person:key1},{
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
  ...
  let StartFollow = async(key1) =>{
    await axios.put("https://developerroombackend.onrender.com/api/profiles/follow",{followed_person:key1},{
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
