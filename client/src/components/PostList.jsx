...
let PostList = () => {
  ...
  const getUser = async () => {
    let { data } = await axios.get("https://developerroombackend.onrender.com/api/users/me", {
      headers: {
  ...
  const getPosts = async () => {
    let { data } = await axios.get("https://developerroombackend.onrender.com/api/posts/", {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
  ...
  let submitCreatePost = async (e) => {
    ...
    if (localPost.text.trim() !== "") {
      const { data } = await axios.post("https://developerroombackend.onrender.com/api/posts/", localPost, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("devroom")}`,
        },
  ...
  let clickDeletePost = async (postId) => {
    const { data } = await axios.delete(`https://developerroombackend.onrender.com/api/posts/${postId}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
  ...
  let clickLikePost = async (postId) => {
    const { data } = await axios.put(`https://developerroombackend.onrender.com/api/posts/like/${postId}`, {}, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      }
